...
################################################################################
# Compiled regular expressions  (compiled once at module load — no ReDoS risk) #
################################################################################
...
def sanitize_identifier(identifier: str) -> str:
    ...
    Delegates to :func:`~fastapi_tenancy.utils._sanitize.core_sanitize_identifier`
    so there is a single source of truth shared with ``db_compat``.
    ...
    """
    return core_sanitize_identifier(identifier)
